...
public class FilaListaPedido extends BaseAdapter {
	
	private String[] _filas;
	
	public FilaListaPedido(Context contexto, int id_recurso, String[] filas){
		_filas=filas;
	}
	...
	public View getView(int posicion, View vista_conversion, ViewGroup padre) {
		...
		if (vista_conversion == null) {
			...
			vista_fila = inflador.inflate(R.layout.fila_pedidos,null);
		} else {
